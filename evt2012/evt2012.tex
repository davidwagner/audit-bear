...
Many studies have shown the various security weaknesses of DRE machines \cite{}. 
While many states are moving away from this method of voting for these reasons, 
they are still in widespread use and our tool provides easy-to-apply techniques 
that make results and future election more reliable. Our tool does not attempt to 
encourage continued or increased use of DRE machines.  Although the iVotronic is 
most likely susceptible to many security exploits, our tool does not aim to detect 
...
tampering, finding a number of uncounted votes is important too. In this work we 
...
firstly, unofficial data detracts from the validity of our analyses. Secondly, these 
...
\comment{Include a paragraph about the privacy implications of the logs.}

\subsection{Other DRE Machines}
\comment{Discuss generality and defend our choice of iVotronic here.}
