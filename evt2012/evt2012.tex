...
\comment{Election officials are tasked with the difficult job of ensuring fair
  ...
  voters.  A number of election day events can conspire to thwart 
...
\comment{However, log data contains a trove of information that can shed light
...
under-counted. \cks{This said we detect over-counting too. How do we do that? I
  took it out for now.} We do this by looking for discrepencies between the
...
going to the polling place in the first place if they expect long lines, what is
...
\cks{I took out the disclaimer paragraph about all the assumptions we're
  making. I thought we might not need it anymore since we justify our
  assumptions w/in the paragraph a bit more now. But put it back in if you think
  we should.}
