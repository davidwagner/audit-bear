...
Our tool contributes to an election audit in the following ways.

\begin{itemize}
\item{Identification of potential errors in the software, hardware, and system 
configuration. Some errors may raise the possibility of deeper problems.}
\item{Reports on human error by election officials in following procedures. 
Patterns across the logs that suggest shortcomings in training officials are 
identified.}
\item{Provides statistical analysis of voter flow.  This allows for resouce 
allocation improvement in future elections.}
\end{itemize}
...
\begin{figure*}[htbp]
\begin{center}
    \includegraphics{PEBsNotUploaded1.eps}
\end{center}
...
\begin{figure*}[htbp]
\begin{center}
    \includegraphics{VotesNotUploaded.eps}
\end{center}
...
\begin{figure*}[htbp]
\begin{center}
    \includegraphics{NotCalibrated.eps}
\end{center}
...
\begin{figure*}[htbp]
\begin{center}
    \includegraphics{IncompleteAuditData.eps}
\end{center}
...
\begin{figure*}[htbp]
\begin{center}
    \includegraphics{OpenClosePEBs.eps}
\end{center}
...
\begin{figure*}[htbp]
\begin{center}
    \includegraphics{BallotsActivatedWithMasterPEB.eps}
\end{center}
...
\begin{figure*}[htbp]
\begin{center}
    \includegraphics{ResetClock.eps}
\end{center}
...
\begin{figure*}[htbp]
\begin{center}
    \includegraphics{DateAnomaly.eps}
\end{center}
